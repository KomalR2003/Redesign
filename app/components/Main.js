            ...
            <div className='flex flex-col md:flex md:flex-row '>
                ...
                <div className='w-12/12 md:w-5/12  '>
                    ...
                    <div className='flex md:flex  '>
                        ...
                        <div className='absolute ms-20 mt-20 md:ms-[12%] md:mt-32 '>
                            <h1 className='text-2xl capitalize font-semibold md:uppercase md:text-4xl'>Transcend your</h1>
                            <h1 className='text-[#ED1C24] text-4xl mt-2 font-semibold md:text-6xl md:mt-3'>BUSINESS</h1>
                            <h1 className='text-[#ED1C24] text-4xl mt-2 font-semibold md:text-6xl md:mt-3'>WITH US</h1>
                            <p className='text-lg font-[500] mt-3 md:text-2xl md:mt-5'>By utilizing our customized web <br /> and mobile application<br /> development services</p>
                            <button className='text-[#ED1C24] font-[500] text-xl border border-red-500 mt-16 px-10 py-3 rounded-xl sm:block hidden '>Read more</button>
                        </div>
                    </div>
                 ...
                 <div className='flex flex-row justify-center 2xl:hidden xl:hidden lg:hidden md:hidden '>
                        <Link href='/d66'><h1 className='h-3 w-3  bg-black rounded-full'></h1>  </Link>
                ...
                <div className='flex flex-row w-12/12 md:flex md:flex-row md:w-7/12 md:ms-24'>
                    ...
                    <div className='hidden 2xl:flex ms-20 mt-48 flex-col lg:flex xl:flex '>
                        ...
                        <Link href='/d105'><h1 className='h-3 w-3 mt-3 lg:mt-3 xl:mt-3 bg-gray-400 rounded-full'></h1>  </Link>
                    </div>
